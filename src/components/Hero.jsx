  ...
  return (
    ...
    flex-col ${styles
      ...
      flex-col xl:px-0 sm:px-16 px-6`}>
        <div className='discount flex flex-row items-center
        ...
        <h1 className='font-poppins font-semibold ss:text-[68px] text-[50px] text-white
        ss:leading-[100px] leading-[75px] w-full'>Payment Method.</h1>
        <p className={`${styles.paragraph}
        max-w-[500px]`}>Our team of experts uses a
          methodology to identify the credit cards most
          likely to fit your needs. We examine annual
