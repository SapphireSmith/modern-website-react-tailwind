...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY}
              ...
              <ul className='list-none mt-4'>
                {
                  footerLink.links.map((link, index) => (
                    <li key={link.name}
                      className={`font-poppin font-normal
                    text-[16px]  text-dimWhite leading-[24px] 
    ...
    md:flex-row flex-col pt-6 border-t-2'>
      <p className='font-poppins font-normal text-center
      text-[19px] leading-[28px] text-white'>
